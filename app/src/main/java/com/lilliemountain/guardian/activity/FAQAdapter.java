...
public class FAQAdapter extends BaseExpandableListAdapter {
    ...
    private List<FAQ> _listDataHeader;

    public FAQAdapter(Context context, List<FAQ> listDataHeader) {
    ...
    public Object getChild(int groupPosition, int childPosititon) {
        return this._listDataHeader.get((groupPosition)).getAnswer();
    }
    ...
    public Object getGroup(int groupPosition) {
        return this._listDataHeader.get(groupPosition).getQuestion();
    }
